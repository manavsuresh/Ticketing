...
router.register(r'admin/todo', views.todoViewSet)
router.register(r'admin/creds',views.credsViewSet)
...
urlpatterns = [
    ...
    # path('index/register/',log.adduser,name='add_user'),
    ...
    # path('index/todo/delete/<int:id>',tick.todo_delete,name='todo_delete'),
